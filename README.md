...
The website allows the user to search through the articles (by typing a keyword such as a brand, a category, or a model), browse the results, sort them by popularity, brand or price, and add them to their cart.
